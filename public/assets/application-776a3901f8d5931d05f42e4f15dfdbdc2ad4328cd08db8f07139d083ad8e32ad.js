...
(function() {
  var addMarker, clearData, createActionButtons, createHeatmapLayerInto, createTableLine, createWindLayerInto, current, exports, highlightTableLine, noResultTableLine, putParticle, searchBusStops, selectIcon, setCurrentPosition, setLatLng, setResult;
  ...
  selectIcon = function(fire_status) {
    var icon, icons;
    icons = {
