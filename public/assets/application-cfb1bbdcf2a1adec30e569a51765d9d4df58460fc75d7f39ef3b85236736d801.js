...
(function() {
  var addMarker, clearData, createActionButtons, createTableLine, current, exports, highlightTableLine, noResultTableLine, searchBusStops, setCurrentPosition, setLatLng, setResult;
...
(function() {
  var _getFullDate, current, exports;
  ...
  exports.loadTimeDimension = function(map) {
    var fireLayer, player, timeDimension, timeDimensionControl, timeDimensionControlOptions, windLayer;
    console.log('LOAD!!');
  ...
  L.TimeDimension.Layer.FIREHeatMap = L.TimeDimension.Layer.extend({
    ...
    _getDataForTime: function(time) {
      ...
      return $.getJSON('/data/fire/' + _getFullDate(time) + '.json', (function(data) {
  ...
  L.TimeDimension.Layer.WindMap = L.TimeDimension.Layer.extend({
    ...
    _getDataForTime: function(time) {
      ...
      return this._baseLayer.loadData('/data/fire/' + _getFullDate(time) + '.json', '/data/wind.json');
    }
  });
  ...
  L.timeDimension.layer.windMap = function(options, map) {
