...
(function() {
  var addMarker, clearData, createActionButtons, createHeatmapLayerInto, createTableLine, current, exports, highlightTableLine, noResultTableLine, searchBusStops, setCurrentPosition, setLatLng, setResult;
  ...
  exports.initMap = function(map, lat, lng, zoom) {
    ...
    zoom = exports.isBlank(zoom) ? 4 : zoom;
