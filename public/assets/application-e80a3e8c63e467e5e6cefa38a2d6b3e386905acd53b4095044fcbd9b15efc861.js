...
(function() {
  var addMarker, clearData, createActionButtons, createHeatmapLayerInto, createTableLine, createWindLayerInto, current, exports, highlightTableLine, noResultTableLine, putParticle, searchBusStops, setCurrentPosition, setLatLng, setResult;
  ...
  createHeatmapLayerInto = function(map) {
...
(function() {
  ...
  exports.loadTimeDimension = function(map) {
    var icon, player, timeDimension, timeDimensionControl, timeDimensionControlOptions;
    console.log('LOAD!!');
