...
(function() {
  ...
  $(function() {
    var $form, latitude, longitude, map, marker;
...
(function() {
  ...
  exports.loadTimeDimension = function(map) {
    var player, timeDimension, timeDimensionControl, timeDimensionControlOptions;
    console.log('LOAD!!');
    ...
    return map.addControl(timeDimensionControl);
  };
